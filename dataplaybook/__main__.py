...
def main():
    ...
    parser.add_argument("files", type=str, nargs="+", help="The playbook yaml file")
    ...
    setup_logger()
    set_logger_level({"dataplaybook.loader": "info"})
    ...
    for file in files:
        ...
        try:
            tasks.append(DataPlaybook(modules=extra_modules, yaml_file=file.name))
